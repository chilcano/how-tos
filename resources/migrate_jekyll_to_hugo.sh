...
printf "> rename existing favicon.ico: ${HOME}/${GH_ROOT_DIR}/${REPONAME_TARGET_HUGO}/${HUGO_SCRIPTS_DIR}/static/favicon.ico \n\n"
printf "> target: ${HOME}/${GH_ROOT_DIR}/${REPONAME_TARGET_HUGO}/${HUGO_SCRIPTS_DIR}/static/favicon.ico \n\n"
