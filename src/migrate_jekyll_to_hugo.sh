...
# source <(curl -s https://raw.githubusercontent.com/chilcano/how-tos/main/src/migrate_jekyll_to_hugo.sh)
# source <(curl -s https://raw.githubusercontent.com/chilcano/how-tos/main/src/migrate_jekyll_to_hugo.sh) -d=site01
# source <(curl -s https://raw.githubusercontent.com/chilcano/how-tos/main/src/migrate_jekyll_to_hugo.sh) -u=chilcano -s=https://github.com/chilcano/ghpages-holosec.git -d=site02 -t=hugo-theme-cactus
...
printf "> source: ${HOME}/${GH_ROOT_DIR}/${REPONAME_SOURCE_JEKYLL}/assets/img/logo*.png \n"
printf "> target: ${HOME}/${GH_ROOT_DIR}/${REPONAME_TARGET_HUGO}/${HUGO_SCRIPTS_DIR}/static/images/logo.png \n"

printf "==> Copy the favicon: \n"
printf "> source: ${HOME}/${GH_ROOT_DIR}/${REPONAME_SOURCE_JEKYLL}/favicon.ico \n"
printf "> rename existing favicon.ico: ${HOME}/${GH_ROOT_DIR}/${REPONAME_TARGET_HUGO}/${HUGO_SCRIPTS_DIR}/static/images/favicon.ico \n"
printf "> target: ${HOME}/${GH_ROOT_DIR}/${REPONAME_TARGET_HUGO}/${HUGO_SCRIPTS_DIR}/static/images/favicon.ico \n\n"
