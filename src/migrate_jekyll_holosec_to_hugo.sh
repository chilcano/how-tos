...
# source <(curl -s https://raw.githubusercontent.com/chilcano/how-tos/master/src/migrate_jekyll_holosec_to_hugo.sh)
# source <(curl -s https://raw.githubusercontent.com/chilcano/how-tos/master/src/migrate_jekyll_holosec_to_hugo.sh) -u=chilcano -s=https://github.com/chilcano/ghpages-holosec.git -d=ghpages-holosecio -t=hugo-theme-cactus
