...
5. [DAST - Project Discovery Nuclei - Vulnerability scanner](src/hacktools/project-discovery-nuclei.md)
...
10. [DefectDojo - Application Security Posture Management (ASPM) and Vulnerability Management](doc/defectdojo-guide.md)