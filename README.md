...
17. [Install TightVNC - VNC remote access on Ubuntu 20.04](doc/install_tightvnc.md)
18. [Install Apache Guacamole - Remote access Gateway on Ubuntu 20.04](doc/install_apache_guacamole.md)
19. [Create booteable USB Ubuntu](doc/booteable_usb_on_ubuntu.md)  
20. [Google Drive on Ubuntu with XFCE](doc/google_drive_on_linux.md)  
21. [Change the brightness level of a screen](doc/change_brightness_level.md)
22. [Screenshot and Screen Annotation Tools](doc/screen_tools.md) 
23. [Regex examples in VSCode](doc/regex_examples.md)
24. [Generate and import SSH Pub Key to all AWS Regions](doc/import_ssh_keys_to_aws_regions.md)
25. [Disabling sleeping when close laptop lid](doc/disable_sleeping_when_close_laptop_lid.md)
26. [Docker useful commands](doc/docker_useful_commands.md)
27. [Install Code-Server on Headless Raspberry Pi 3B+ with Ubuntu 64bit](doc/install_code_server_on_headless_rpi.md)
28. [Take screenshots silently in Ubuntu with xfce4-screenshooter](silent_screenshooter.md)
29. [Install Flameshot and other annotation tools in Linux](doc/flameshot.md)
30. [Install AutoFirma Java App in Ubuntu 19.10](doc/install_autofirma_app_in_ubuntu19.10.md)
31. [Installation of WSO2 MB, Apache Qpid, RabbitMQ and Apache ActiveMQ on CentOS](doc/install_wso2mb_qpid_rabbitmq_activemq.md)
...
36. [Installing and uninstalling IDE and DevOps Tools for multiple platforms](doc/ide_and_devops_tools.md)
