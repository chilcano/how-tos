...
30. [Migrate of GitHub Page site from Jekyll to Hugo](doc/migrate_jekyll_to_hugo.md)
31. [Building static website with Jekyll and Hugo and hosted on GiHub Pages](doc/static_website_on_ghpages.md)
32. [Installing and using NMAP](doc/nmap_commands.md)
33. [Installing and uninstalling IDE and DevOps Tools for multiple platforms](doc/ide_and_devops_tools.md)
